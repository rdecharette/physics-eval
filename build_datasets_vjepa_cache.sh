...
python convert_videos.py --dataset "/nfs/data/workspaces/rdechare/codes/physics-eval/../physics-sim/output/sims/v4_bis/" --filter "**/dl3dv/random/**/_fps-25_render.mp4" --ext ".mp4" --height 256 --workers 32 --fps 30 --dst "cache/datasets_vjepa-ready/newtphys/" &&
